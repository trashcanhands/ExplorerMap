...
Manual:<br>
Download the .zip file using the green !(https://imgur.com/kFIrpY3.png) button. Extract the .zip file then remove the -master from extracted ExplorerMap-master folder then copy the ExplorerMap
